...
namespace Melnik\BlogBundle\Tests\Twig\Extensions;

use Melnik\BlogBundle\Twig\Extensions\MelnikBlogExtension;

class MelnikBlogExtensionTest extends \PHPUnit_Framework_TestCase
{
    public function testCreatedAgo()
    {
        $blog = new MelnikBlogExtension();
